  ...
  <div class="app-container">
    ...
    <div class="ccInfo">
      ...
      <div class="main">
        ...
        <p class="gray"><span>total{{ coursePublish.lessonNum }}videos</span></p>
        <p><span>Categories: {{ coursePublish.subjectLevelOne }} — {{ coursePublish.subjectLevelTwo }}</span></p>
...
export default {
  ...
  created() {
    if (this.$route.params && this.$route.params.id) {
      ...
      this.getCoursePublishId(this.courseId)
    }
  },
