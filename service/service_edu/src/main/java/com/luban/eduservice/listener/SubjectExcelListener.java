package com.luban.eduservice.listener;
...
public class SubjectExcelListener extends AnalysisEventListener<SubjectData> {
    ...
    // Because SubjectExcelListener is not managed by Spring, so no injections in here.
    // To use EduSubjectService, it must be passed in through the constructor.
    ...
    public void invoke(SubjectData subjectData, AnalysisContext analysisContext) {
        if (subjectData == null) {
            throw new GuliException(20001, "Excel data empty!");
        }
